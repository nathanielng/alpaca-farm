---
name: Create Python CLI Script with input from stdin
description: This is skill creates a Python script that takes input from stdin
---

# Create Python CLI Script with input from stdin

## Instructions

Create a command line utility that processes input from stdin and outputs to stdout, with the following features:
- uses argparse
- uses logging.basicConfig

It should follow the format of the examples below.


## Examples

1. **Example without Strands SDK**
