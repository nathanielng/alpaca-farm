...
Environment file: .env
  ONEMAP_REGISTERED_EMAIL=
  ONEMAP_REGISTERED_PASSWORD=
  ONEMAP_ACCESS_TOKEN=
"""
...
EXAMPLE_PROMPTS = [
    ...
    "Tell me about IOI Central Boulevard Towers",
    "Tell me about 1 Shenton Way",
    "Where is the National Museum",
    "How do I get from HDB Hub to National Library?",
    "What are the building details for HDB Hub?"
